...
package cn.chinapost.com.tinker.zxing.decode;
...
import cn.chinapost.com.tinker.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        if (message.what == R.id.auto_focus) {
            ...
            mIntent.putExtra("content", result.getText());
